...
from twenty48Env import twenty48Env
...
# set up environments
env = twenty48Env()
train_py_env = twenty48Env()
eval_py_env = twenty48Env()
...
def compute_avg_return(environment, policy, num_episodes=10):
    ...
    for i in range(num_episodes):
        print(f'game {i} completed', end='\r')
        time_step = environment.reset()
        episode_return = 0.0

        while not time_step.is_last():
            # print(f'working... episode return ={episode_return}',end='\r')
